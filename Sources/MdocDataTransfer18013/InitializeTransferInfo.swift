...
public struct InitializeTransferData: Sendable {
	...
	public init(dataFormats: [String : String], documentData: [String : Data], docDisplayNames: [String: [String: [String: String]]?], privateKeyData: [String : String], trustedCertificates: [Data], deviceAuthMethod: String, idsToDocTypes: [String : String], hashingAlgs: [String: String], sendDeviceResponseManually: Bool?) {
		...
		self.sendDeviceResponseManually = sendDeviceResponseManually ?? false
    }
	...
	public let sendDeviceResponseManually: Bool
    ...
    public func toInitializeTransferInfo() -> InitializeTransferInfo {
        ...
        let deviceAuthMethod = DeviceAuthMethod(rawValue: deviceAuthMethod) ?? .deviceMac
			return InitializeTransferInfo(dataFormats: dataFormats, documentObjects: documentObjects, docDisplayNames: docDisplayNames, privateKeyObjects: privateKeyObjects, iaca: iaca, deviceAuthMethod: deviceAuthMethod, idsToDocTypes: idsToDocTypes, hashingAlgs: hashingAlgs, sendDeviceResponseManually: sendDeviceResponseManually)
    }
}
...
public struct InitializeTransferInfo {
	...
	public let hashingAlgs:[String: String]
	/// Whether to send the device response manually
	public let sendDeviceResponseManually: Bool
}